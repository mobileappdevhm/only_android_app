...
public class SkippedLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skipped_login);
        ...
        card_courses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent courses_intent = new Intent(SkippedLoginActivity.this, CoursesActivity.class);
        ...
        card_favorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent favorites_intent = new Intent(SkippedLoginActivity.this, FavoritesActivity.class);
        ...
        card_locations.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent locations_intent = new Intent(SkippedLoginActivity.this, LocationsActivity.class);
